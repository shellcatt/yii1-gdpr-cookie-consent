...
Yii::import('GDPR.helpers.ArrayHelper');

class CookieConsentComponent extends CComponent implements CategoryInterface, CookieComponentInterface
{
     ...
     */
    public $complianceType = self::COMPLIANCE_TYPE_OPT_OUT;
    ...
    {
//        $this->complianceType = self::COMPLIANCE_TYPE_OPT_IN;
        $this->complianceType = self::COMPLIANCE_TYPE_OPT_OUT;
//        $this->complianceType = self::COMPLIANCE_TYPE_INFO;
...
//        print_r(Yii::app()->createAbsoluteUrl($this->urlSettings[0]));die;
        $this->urlSettings = Yii::app()->createUrl($this->urlSettings[0]);
        $this->urlPrivacyPolicy = Yii::app()->createAbsoluteUrl($this->urlPrivacyPolicy[0]);
    }
