...
<p>Pablo de Queiroz und Silvina Igova GbR ("us", "we", or "our") operates the https://salsamas.de/ website (hereinafter referred to as the "Service").</p>
...
<ul>
    <li>
        <p><strong>Service</strong></p>
                <p>Service is the https://salsamas.de/ website operated by Pablo de Queiroz und Silvina Igova GbR</p>
            </li>
    <li>
...
<h2>Use of Data</h2> 
<p>Pablo de Queiroz und Silvina Igova GbR uses the collected data for various purposes:</p>    
<ul>
...
<p>If you are from the European Economic Area (EEA), Pablo de Queiroz und Silvina Igova GbR legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
<p>Pablo de Queiroz und Silvina Igova GbR may process your Personal Data because:</p>
<ul>
...
<p>Pablo de Queiroz und Silvina Igova GbR will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes and enforce our legal agreements and policies.</p>
<p>Pablo de Queiroz und Silvina Igova GbR will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer periods.</p>    
...
<p>Pablo de Queiroz und Silvina Igova GbR will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h2>Disclosure of Data</h2>


<h3>Legal Requirements</h3>
<p>Pablo de Queiroz und Silvina Igova GbR may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of Pablo de Queiroz und Silvina Igova GbR</li>
...
<p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Pablo de Queiroz und Silvina Igova GbR aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.</p>
...
<ul>
    ...
    <li>
        <p><strong>The right to withdraw consent.</strong> You also have the right to withdraw your consent at any time where Pablo de Queiroz und Silvina Igova GbR relied on your consent to process your personal information.</p>
    </li>
</ul>
...
<p><span style="font-weight: 400;">You can opt-out of having made your activity on the Service available to Google Analytics by installing the Google Analytics opt-out browser add-on. The add-on prevents the Google Analytics JavaScript (ga.js, analytics.js and dc.js) from sharing information with Google Analytics about visits activity.</span></p>
<p><span style="font-weight: 400;">For more information on the privacy practices of Google, please visit the Google Privacy &amp; Terms web page: <a href="https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a></span></p>
...
<ul>
    <li>By email: info@salsa-mas.de</li>
    <li>By visiting this page on our website: https://salsamas.de/privacy-policy</li>
</ul>